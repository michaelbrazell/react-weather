...
/***/ function(module, exports, __webpack_require__) {
	...
	var Weather = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var location = _state.location;
	    var isLoading = _state.isLoading; // Uses ES6 destructuring. Equal to this.state.temp or this.state.location;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WeatherMessage = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var location = _props.location; // ES6 destructuring. Equal to this.props.temp; this.props.location;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=5c33f3265314ae27bbb4d2bae10afe55&units=imperial';
